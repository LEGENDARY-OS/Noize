...
BOT_TOKEN = getenv("5260589630:AAGGopcuJ6Uh8kFT1Uy1bruaEQJ2HMkURCI")
BOT_NAME = getenv("Crazy Music v2")
BOT_USERNAME = getenv("Itscrazy2_bot")
ASSID = int(getenv("1852117707"))
ASSNAME = getenv("Ken Kenaki")
ASSUSERNAME = getenv("Sw1s5881")
BOT_ID = int(getenv("5257312176"))
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "master")
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/LEGENDARY-OS/Noize")
USERS = getenv("1805019557")
...
UPDATE = getenv("LEGENDBOT_AI")
SUPPORT = getenv("LEGENDBOT_OP")
...
ASSISTANT_NAME = getenv("Ken Kenaki")
